...
- ### 版本回退
    ...
    + ### 查看提交历史，选择还原版本
        ...
        >
        > Git的commit id是一个SHA1计算出来的，用十六进制表示
...
- ### 远程仓库
    ...
    + ### 本地仓库与GitHub仓库关联
            ...
            $ git remote add origin git@github.com:luanxxys/learngit.git
    ...
    把本地库的所有内容推送到远程库上
        ...
        >
        > 由于远程库是空的，我们第一次推送master分支时，加上了-u参数，Git不但会把本地的master分支内容推送的远程新的master分支，还会把本地的master分支和远程的master分支关联起来，在以后的推送或者拉取时就可以简化命令，使用命令git push origin master推送最新修改
        >
        > 要查看远程库的信息
    ...
    + ### 从远程仓库克隆
            ...
            $ git clone git@github.com:luanxxys/gitskills.git
            $ cd gitskills
            $ ls
